...
export default function ContactForm() {
    ...
    const onSubmit = async (data: any) => {
      ...
      axios.post('/api/sendFranchiseForm', request)
        .then(response => {
            setSending(false)
            setFormSent(true)
            reset();
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-24">
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-secondary">Intéressé par une franchise ?</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Contactez-nous dès aujourd'hui pour en savoir plus sur cette opportunité unique.
            </p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-24" id="contact">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              {formSent ? <p data-testid='confimationMessage' className='m-4'>Votre demande de franchise a bien été envoyé</p> : ''}                           
              {sending? 
